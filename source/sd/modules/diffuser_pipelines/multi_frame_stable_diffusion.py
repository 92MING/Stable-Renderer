<<<<<<< HEAD:source/sd/diffuser_pipeline/multi_frame_stable_diffusion.py
import torch
import PIL
import numpy
import cv2
...
def make_inpaint_condition(image, image_mask):
    ...
    image = torch.from_numpy(image)
    return image
>>>>>>> refs/remotes/origin/main:source/sd/modules/diffuser_pipelines/multi_frame_stable_diffusion.py
