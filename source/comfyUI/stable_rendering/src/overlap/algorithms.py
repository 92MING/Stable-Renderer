...
class FrameDistance:
    ...
    The remixed latent is the weighted sum of the reciprocal of frame distances
    """
    def overlap(self,
                latent_seq: torch.Tensor,
                frame_index_trace: list,
                ...
                y_position_trace: list,
                **kwargs) -> torch.Tensor: 
        # compute dense frame distance from all occurrence of vertex
...
class PixelDistance:
    ...
    The remixed latent is the weighted sum of the reciprocal of frame-wise pixel distances
    """
    def overlap(self,
                latent_seq: torch.Tensor,
                frame_index_trace: list,
...
class PerpendicularViewNormal:
    ...
    The remixed latent is the weighted sum of the reciprocal of the difference between view vector and normal vector
    """
    def overlap(self,
                latent_seq: torch.Tensor,
                frame_index_trace: list,
