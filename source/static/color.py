...
class Color:
    ...
    def __mul__(self, value):
        if isinstance(value, Color):
            ...
            raise TypeError(f'Cannot multiply Color and {type(value)}')
    ...
    def __truediv__(self, value):
        if isinstance(value, Color):
            ...
            raise TypeError(f'Cannot divide Color and {type(value)}')
    ...
    def __iadd__(self, value):
        if isinstance(value, Color):
            ...
            raise TypeError(f'Cannot add Color and {type(value)}')
        self._tidy_rgba()
        return self
    ...
    def __isub__(self, value):
        if isinstance(value, Color):
            ...
            raise TypeError(f'Cannot subtract {type(value)} from Color')
        self._tidy_rgba()
        return self
