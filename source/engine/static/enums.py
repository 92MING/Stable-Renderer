...
__all__.extend(['MouseButton', 'InputAction', 'InputModifier', 'Key'])
# endregion
...
__all__.extend(['TextureWrap', 'TextureFilter', 'TextureFormat'])
# endregion
...
__all__.extend(['PrimitiveType', 'ShaderType'])
# endregion