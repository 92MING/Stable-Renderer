...
from typing import Callable, Tuple, Union, List, TypeVar, Type, Optional, TYPE_CHECKING, Dict, Any
...
class CorrespondenceMap:
    ...
    def FromExisting(cls,
        ...
        :param directory: This can be:
            * directory where id maps are stored as .npy. If not given, the default output path with latest timestamp will be used.
        ...
        if enable_cache:
            ...
            if cache_path is not None:
                cache_corr_map = cls.LoadFromCache(cache_path)
