...
from engine.runtime.components import Camera, HelicalOrbit, CorrMapRenderer
...
if __name__ == '__main__':
    ...
    class Sample(Engine):
        def beforePrepare(self):
            ...
            sphere_mat = Material.DefaultOpaqueMaterial()
            noise_tex = Texture.CreateNoiseTex(t_wrap=TextureWrap.CLAMP_TO_EDGE, s_wrap=TextureWrap.CLAMP_TO_EDGE)
            sphere_mat.addDefaultTexture(noise_tex, DefaultTextureType.NoiseTex,)
            ...
            sphere.addComponent(CorrMapRenderer, mesh=sphere_mesh, materials=sphere_mat)
